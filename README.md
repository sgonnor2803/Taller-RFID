...
El taller combina una explicación teórica accesible con demostraciones prácticas realizadas mediante dispositivos reales, así como un análisis general de las herramientas más utilizadas en el estudio y evaluación de sistemas RFID. De este modo, se busca proporcionar una base sólida que permita entender tanto el funcionamiento como las posibles debilidades de estas tecnologías.

Este trabajo ha sido elaborado por el **Grupo 5**, integrado por:
- Sergio González  
- Iván Paúl  
- Manuel Pérez  
- Javier Calvillo  
